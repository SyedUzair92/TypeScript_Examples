...
var _ducktype1 = { name: "test", id: 1 };
_ducktype1 = { id: 4, name: "test1" };
console.log(_ducktype1);
//Case 2
_ducktype1 = { id: 5, new_name: new_name }; //error ?? why because parameters are same 
...
var x; // no error becuase now 'x' can have any name, just that the property should be of type string
...
//case 4b
var _ducktype3 = { id: 7, name_new: "demi" };
...
//case 6
//case 6a
var _ducktype4 = { name: "demi", id: 6, age: 12 };
